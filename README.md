...
_N.B.: `http://localhost/` must be served by a PHP script through standard web server feature like directory index or URL rewriting. If this is not the case the control panel will not fully load.
